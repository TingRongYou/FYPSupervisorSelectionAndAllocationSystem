...
class ImageStorageDAO {
    ...
    public function storeProfilePhoto($uploadedFile, $userID) {
        ...
        if ((int) $uploadedFile["size"] > self::MAX_IMAGE_SIZE) {
            ...
            return [
                "success" => false,
                "message" => "Profile photo cannot exceed 5MB"
            ];
        }
        ...
        if (
            ...
            return [
                "success" => false,
                "message" => "Invalid profile photo upload source"
            ];
        }
        ...
        if (!in_array($mimeType, self::ALLOWED_MIME_TYPES, true)) {
            ...
            return [
                "success" => false,
                "message" => "Only JPG or PNG profile photos are allowed"
            ];
        }
    ...
    private function uploadErrorMessage($uploadErrorCode) {
        ...
        if (
            ...
            return "Profile photo cannot exceed 5MB";
        }
