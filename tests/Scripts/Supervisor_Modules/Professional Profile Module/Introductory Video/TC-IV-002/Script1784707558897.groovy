...
String invalidVideoUrl = 'https://example.com/not-a-video'
String videoDescription = 'This description is valid, but the external video link is intentionally invalid.'
...
TestObject pageTitle = byXpath('pageTitle', "//*[normalize-space()='Introductory Video']")
TestObject externalTab = byXpath('externalTab', "//label[@id='externalTab']")
TestObject introVideoLinkInput = byXpath('introVideoLinkInput', "//input[@name='introVideoLink']")
TestObject descriptionTextarea = byXpath('descriptionTextarea', "//textarea[@name='introVideoDescription']")
TestObject publishButton = byXpath('publishButton', "//button[@type='submit' and normalize-space()='Publish Video']")
...
WebUI.setText(introVideoLinkInput, invalidVideoUrl)
...
Boolean isInvalid = WebUI.executeJavaScript(
	"return !document.getElementById('introVideoLink').checkValidity();",
	null
)

assert isInvalid == true

// Page should remain on Introductory Video because invalid URL is not submitted
WebUI.verifyElementPresent(pageTitle, 10)
