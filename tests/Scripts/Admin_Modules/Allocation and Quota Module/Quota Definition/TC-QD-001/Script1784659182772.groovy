...
TestObject validStatus5836 = byXpath(
	'validStatus5836',
	"//article[contains(@class,'quota-row') and @data-row='5836']//span[@data-status-badge and normalize-space()='Valid']"
)
...
WebUI.setText(quotaInput5836, '9')

// Verify quota status remains valid
WebUI.verifyElementPresent(validStatus5836, 10)

// Save quota
WebUI.verifyElementClickable(saveQuotaButton)
WebUI.click(saveQuotaButton)
...
WebUI.verifyTextPresent('Update Successful - Supervisor quota limit has been updated. The new base quota is now active.', false)

// Verify updated quota value and valid status
WebUI.verifyTextPresent('9', false)
WebUI.verifyTextPresent('Valid', false)
