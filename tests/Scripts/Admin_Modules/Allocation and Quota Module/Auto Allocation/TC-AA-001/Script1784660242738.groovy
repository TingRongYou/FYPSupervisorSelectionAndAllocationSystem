...
WebUI.verifyTextPresent('Run Auto Allocation', false)

// Positive condition: button should be clickable
...
// Expected result
WebUI.verifyTextPresent('Auto-Allocation Complete', false)
WebUI.verifyTextPresent('students successfully matched', false)
WebUI.verifyTextPresent('Notification records generated', false)

// Verify allocation log section exists
