...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .directory-title h2, .status-card h2 { margin: 0; color: #10263d; font-size: 17px; }
        ...
        input, select { height: 36px; border: 1px solid #dbe6f0; border-radius: 7px; background: #f6f8fb; color: #1d2b3a; padding: 0 11px; font-size: 13px; }
        .search-wrap input { width: 210px; padding-left: 34px; }
        .filter-form select { width: 170px; }
        .button { border: 0; min-height: 36px; border-radius: 7px; padding: 0 14px; background: #0d5be8; color: #fff; font-weight: 800; font-size: 12px; cursor: pointer; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; }
        ...
        .table-head { padding: 12px 22px; background: #fbfdff; color: #8a9caf; font-size: 9px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase; border-top: 1px solid #edf2f7; border-bottom: 1px solid #edf2f7; }
        ...
        .name { margin: 0; color: #10263d; font-weight: 900; font-size: 13px; }
        .meta { margin: 2px 0 0; color: #6b7f91; font-size: 10px; line-height: 1.25; }
        .programme { color: #526a7f; font-size: 12px; line-height: 1.35; }
        .quota-input { width: 58px; height: 34px; text-align: center; color: #0d5be8; font-weight: 900; background: #fff; }
        .quota-hint { margin-top: 6px; color: #7a8da0; font-size: 9px; line-height: 1.25; }
        ...
        .badge { display: inline-flex; min-width: 62px; align-items: center; justify-content: center; border-radius: 999px; padding: 7px 10px; font-size: 10px; font-weight: 900; line-height: 1.1; text-align: center; }
        ...
        .showing { padding: 13px 22px 18px; color: #6b7f91; font-size: 11px; }
        ...
        .summary-label { color: #8a9caf; text-transform: uppercase; letter-spacing: 1px; font-size: 9px; font-weight: 900; }
        .summary-value { color: #10263d; font-size: 24px; margin-top: 4px; }
        .summary-value.danger { color: #d12f2f; font-weight: 900; }
        .summary-note { color: #6b7f91; font-size: 11px; margin-left: 4px; }
        ...
        .save-title { margin: 0; color: #10263d; font-weight: 900; font-size: 12px; }
        .save-subtitle { margin: 2px 0 0; color: #7a8da0; font-size: 10px; }
