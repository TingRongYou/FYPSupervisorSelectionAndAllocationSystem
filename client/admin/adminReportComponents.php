    ...
    */
    ...
    return <<<CSS
        * { box-sizing: border-box; }
        ...
        .submenu-caret { color: #0b66d8; font-size: 14px; font-weight: 900; line-height: 1; transform: rotate(180deg); }
        .report-tree { margin: -4px 0 8px 16px; padding-left: 14px; border-left: 1px solid #c9d8e8; }
    ...
    */
    ...
    return "
        <aside class=\"sidebar\">
            ...
            <a class=\"nav-link has-submenu {$reportsClass}\" href=\"adminCohortOverview.php\">
                <span>Reports</span>
