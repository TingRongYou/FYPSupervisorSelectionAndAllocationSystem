...
<head>
    ...
    <style>
        ...
        .summary-label { color: #7c8da0; font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: 1px; }
        .summary-value { color: #172033; font-size: 18px; font-weight: 900; margin-left: 18px; }
        .updated { color: #7c8da0; font-size: 11px; white-space: nowrap; }
        .table-card { overflow: hidden; }
        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 18px 22px; text-align: left; border-bottom: 1px solid #edf2f7; vertical-align: middle; }
        th { background: #f8fafc; color: #7c8da0; font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: 1px; }
        .student-cell { display: flex; align-items: center; gap: 12px; }
        .avatar { width: 34px; height: 34px; border-radius: 50%; background: #eaf3ff; color: #0d5be8; display: grid; place-items: center; font-size: 11px; font-weight: 900; flex: 0 0 auto; }
        ...
        .status { display: inline-flex; justify-content: center; min-width: 68px; padding: 6px 10px; border-radius: 6px; background: #dcfce7; color: #166534; font-size: 10px; font-weight: 900; text-transform: uppercase; }
        .detail-link { color: #0d5be8; font-size: 12px; font-weight: 900; text-decoration: none; line-height: 1.2; display: inline-block; }
        .detail-link.disabled { color: #9aacc0; pointer-events: none; }
        .footer-row { display: flex; justify-content: space-between; align-items: center; padding: 14px 22px; color: #6b7f91; font-size: 12px; }
            ...
            <div class="page-shell">
                ...
                <section class="table-card card">
                    <?php if (empty($supervisees)): ?>
                        <div class="empty-state">No students are currently assigned under your supervision.</div>
                    <?php else: ?>
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="student-cell">
                                                <div class="avatar"><?php echo e(supervisorInitials($supervisee["fullName"])); ?></div>
                                        ...
                                        <td>
                                            <?php if (!empty($supervisee["requestID"])): ?>
                                            ...
                                            <?php else: ?>
                                                <span class="detail-link disabled">No<br>Details</span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
