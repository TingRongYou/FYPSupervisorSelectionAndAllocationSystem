...
function supervisorBaseStyles() {
    ...
    return <<<CSS
        ...
        * { box-sizing: border-box; }
        ...
        .nav-link, .nav-parent { display: flex; align-items: center; gap: 10px; color: #526a7f; text-decoration: none; padding: 11px 12px; border-radius: 8px; margin-bottom: 6px; font-size: 13px; background: #f1f5f9; border: 0; width: 100%; min-height: 38px; cursor: pointer; transition: background .2s, color .2s, transform .2s; white-space: nowrap; }
        .nav-link:hover, .nav-link.active, .nav-parent.active { background: #eaf3ff; color: #0b66d8; transform: translateX(2px); }
        .nav-text { flex: 1; }
        ...
        .subnav a { position: relative; display: block; color: #6b7f91; text-decoration: none; font-size: 12px; padding: 6px 10px; line-height: 1.25; border-radius: 6px; white-space: nowrap; }
        .subnav a:before { content: ""; position: absolute; left: -22px; top: 50%; width: 16px; height: 1px; background: #cbd8e6; }
        .subnav a:hover,
        .subnav a.active { background: #f1f7ff; color: #0d5be8; font-weight: 800; }
